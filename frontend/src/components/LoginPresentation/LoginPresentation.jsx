...
const ECG_PATH_D = `
M 0 10
L 8 10 L 9 12 L 10 4 L 11 15 L 12 10
L 22 10 L 23 13 L 24 2 L 25 17 L 26 10
L 36 10 L 37 11 L 38 6 L 39 14 L 40 10
L 52 10 L 53 14 L 54 1 L 55 18 L 56 10
L 68 10 L 69 12 L 70 3 L 71 16 L 72 10
L 84 10 L 85 13 L 86 5 L 87 14 L 88 10
L 100 10
`;

const LoginPresentation = ({ isDarkMode, toggleTheme }) => {

  return (
    <div className="login-presentation">

      <button
        className={`lp-moon${isDarkMode ? ' lp-moon--active' : ''}`}
        ...
        <div className="ecg-section">
          <div className="ecg-animation-container">
            <svg viewBox="0 0 100 20" preserveAspectRatio="none" className="ecg-svg">
              ...
              <path className="ecg-pulse" pathLength="100" d={ECG_PATH_D} />
            </svg>
          </div>

          <div className="badges-container">
            {BADGES.map((badge, index) => (
              <div key={badge} className="badge-item" style={{ animationDelay: `${index * 1}s` }}>
                {badge}
              </div>
            ))}
          </div>
